		...
		start: function()
		{
			...
			this.$el.dblclick(function()
			{
				...
				function InitPhotoModel()
				{
					...
					PhotoModel.query(['longitude','latitude','rotation','view_distance','focal_angles','next_photo_ids','pillar_ids','near_pillar_ids','transformer_ids','near_transformer_ids','near_apl_ids']).filter([['id','=',ID]]).all().then(function(photos)
					{
